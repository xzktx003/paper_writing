...
Detailed guidance on the ten components that make up a competitive proposal. For agency-specific
formatting and review criteria, see the per-agency guides (`references/nsf_guidelines.md`,
`references/nih_guidelines.md`, `references/doe_guidelines.md`, `references/darpa_guidelines.md`,
