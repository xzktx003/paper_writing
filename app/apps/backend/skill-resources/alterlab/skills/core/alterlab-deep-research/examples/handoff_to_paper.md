# Handoff Example: alterlab-deep-research → alterlab-paper-writer

This example demonstrates how alterlab-deep-research full mode, after completing research, hands off to alterlab-paper-writer to begin paper writing.

---

## Scenario Setup

The user has completed alterlab-deep-research full mode on the topic "AI-Assisted Quality Assurance in Higher Education: A Comparative Analysis of Implementation Strategies in East Asian Universities." Below is a summary of the research outputs.

---

## alterlab-deep-research Output Summary
...
After completing alterlab-deep-research, the user inputs:
...
## alterlab-paper-writer intake_agent Auto-Detection
...
[DETECTED] Research Question Brief
  - Source: alterlab-deep-research / research_question_agent
  - Status: Complete (FINER 4.6/5)
  - Action: SKIP alterlab-paper-writer Phase 1 (topic scoping)

[DETECTED] Methodology Blueprint
  - Source: alterlab-deep-research / research_architect_agent
  - Status: Complete (pragmatist QCA + document analysis)
  - Action: SKIP alterlab-paper-writer Phase 2 (methodology design)
  - Note: Will integrate into Method section directly

[DETECTED] Annotated Bibliography (18 sources, APA 7.0)
  - Source: alterlab-deep-research / bibliography_agent
  - Status: Complete, quality-screened
  - Action: SKIP alterlab-paper-writer literature search
  - Note: Will use as foundation for Literature Review section

[DETECTED] Synthesis Report
  - Source: alterlab-deep-research / synthesis_agent
  - Status: Complete (3 core findings + 1 contradiction + 2 gaps)
  - Action: SKIP alterlab-paper-writer analysis phase
  - Note: Will structure Findings and Discussion sections around synthesis

Materials Assessment: COMPREHENSIVE
Recommended alterlab-paper-writer mode: full (with accelerated pipeline)
...
| alterlab-paper-writer Step | Normal Workflow | After Handoff | Reason |
|---------------------|---------|-----------|------|
...
## Post-Handoff alterlab-paper-writer Actual Workflow

```
=== alterlab-paper-writer: Accelerated Pipeline ===

Step 1: STRUCTURAL MAPPING
  [outline_agent]
  - Input: RQ Brief + Methodology Blueprint + Synthesis Report
  - Output: Complete paper outline, each section tagged with corresponding alterlab-deep-research materials
  - Output example:
...
Step 3: DISCUSSION + BOOKENDS
  [discussion_writer_agent] → Discussion
    ...
    - Integrates alterlab-deep-research Knowledge Gaps as Future Research
...
**alterlab-paper-writer's Opening Message**:

> I've read your complete outputs from the alterlab-deep-research stage, including:
...
1. **Not copy-paste**: alterlab-paper-writer does not directly copy alterlab-deep-research outputs, but transforms them into the tone and format of an academic paper
2. **May discover new issues**: During the writing process, alterlab-paper-writer agents may discover points missed by alterlab-deep-research and will proactively supplement them
...
4. **Review recommendation auto-connects**: After paper completion, the user can continue with `alterlab-paper-reviewer` for formal review
