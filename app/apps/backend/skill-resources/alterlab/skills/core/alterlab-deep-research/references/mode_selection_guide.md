...
alterlab-deep-research provides 7 modes suited to different research stages and needs. This guide helps users select the most appropriate mode.
...
socratic → alterlab-paper-writer    Write paper directly after Socratic completion
...
systematic-review → alterlab-paper-writer  Write up systematic review as a paper
```

### alterlab-deep-research to alterlab-paper-writer Mode Mapping

| alterlab-deep-research Mode | Output | Maps to alterlab-paper-writer Mode | Description |
|-------------------|------|--------------------------|------|
...
### alterlab-deep-research vs alterlab-paper-reviewer Mode Mapping

| alterlab-deep-research `review` mode | alterlab-paper-reviewer |
|------------------------------|------------------------|
...
```
Step 1: alterlab-deep-research (socratic/full)
          ↓ Research Plan / Full Report
Step 2: alterlab-paper-writer (plan/full)
          ↓ Paper draft
Step 3: alterlab-paper-reviewer (full/guided)
          ↓ Review comments
Step 4: alterlab-paper-writer (revision)
          ↓ Revised paper
...
### Transition: systematic-review → alterlab-paper-writer
