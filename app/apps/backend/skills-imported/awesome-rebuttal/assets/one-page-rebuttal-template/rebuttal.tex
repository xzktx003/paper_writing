...
% awesome-rebuttal fallback note:
% This bundled template is a CVPR/ECCV-style one-page rebuttal fallback.
% Before using it for a venue, confirm the official rules and adapt
% conference name/year, paper ID, anonymity, link, experiment, and page-limit text.
