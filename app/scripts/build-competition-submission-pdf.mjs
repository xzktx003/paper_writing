...
<body>
  <section class="cover">
    ...
    <div class="meta"><span>申报赛道</span><strong>办公场景</strong><span>材料版本</span><strong>2026-08-27</strong><span>视频证据</span><strong>evidence/demo/office-demo.mp4</strong><span>完整性校验</span><strong>submission-manifest.json</strong></div>
  </section>
