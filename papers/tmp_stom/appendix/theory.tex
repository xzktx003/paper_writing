...
% 附录 D. 确定性的下包络实例
\section{A Deterministic Lower-Envelope Instance}
\label{app:figures}

% 以下确定性实例说明直线下包络、切换点合并和代表组合，无需依赖示意图。
The following deterministic instance illustrates line envelopes, merged switching points, and representative combinations without relying on a schematic figure.
