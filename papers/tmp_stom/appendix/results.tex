...
% 本附录记录正文紧凑表格未展开的结果范围。表 1 为 Qwen3-4B/8B/14B/32B 与 Llama-3.1-8B/70B 并列报告 WikiText-2 PPL 和实验流水线的汇总准确率。
This appendix records the scope of results omitted from the compact main tables. Table~\ref{tab:main-ppl} reports WikiText-2 PPL and the evaluation pipeline's aggregate accuracy side by side for Qwen3-4B/8B/14B/32B and Llama-3.1-8B/70B.
