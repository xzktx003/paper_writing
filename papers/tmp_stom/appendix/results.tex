...
This appendix records the scope of results omitted from the compact main tables. WikiText-2 and C4 results for Qwen3-4B/8B/14B/32B and Llama-3.1-8B/70B are fully listed in Table~\ref{tab:main-ppl}; Table~\ref{tab:downstream} reports representative accuracy metrics to preserve readability.
